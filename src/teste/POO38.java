...
public class POO38 {
    public static void main(String[] args) {
        ...
        int SaldoUsuario = 1000,LimiteMin =10, LimiteMax=2000,QuantNotas100 = 1, QuantNotas50 = 1, QuantNotas10 = 0, QuantNotas5 = 0, QuantNotas2 = 10, Continuar = 0, Saque;
        ...
        while(Continuar == 1&&SaldoUsuario > 0){
            ...
            if(Saque <= SaldoUsuario && VerificadorSaque(Saque,QuantNotas100,QuantNotas50,QuantNotas10,QuantNotas5,QuantNotas2) && Saque >= LimiteMin && Saque <=LimiteMax ){
                ...
                System.out.printf("Notas(50):%d\n", Notas50);
                System.out.printf("Notas(10):%d\n", Notas10);
                System.out.printf("Notas(5):%d\n", Notas5);
                System.out.printf("Notas(2):%d\n", Notas2);
                Notas100 = 0;
                Notas50 = 0;
                Notas10 = 0;
                Notas5 = 0;
